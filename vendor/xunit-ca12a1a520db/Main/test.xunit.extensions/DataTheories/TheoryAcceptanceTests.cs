...
public class TheoryAcceptanceTests : AcceptanceTest
{
    ...
    public void TheoryViaDataAcceptanceTest()
    {
        ...
        ResultXmlUtility.AssertAttribute(testNode1, "name", "Stub." + @"PassingTestData(1, ""hello"", 2.3)");

        XmlNode testNode2 = ResultXmlUtility.GetResult(assemblyNode, 0, 1);
        ResultXmlUtility.AssertAttribute(testNode2, "result", "Pass");
        ResultXmlUtility.AssertAttribute(testNode2, "name", "Stub." + @"PassingTestData(42, ""world"", 21.12)");
    }
    ...
    public void TheoryWithInlineDataOfSingleNullPassesNullToTestMethod()
    {
        ...
        ResultXmlUtility.AssertAttribute(testNode, "name", "Stub.PassingTestData(null)");
    }
    ...
    public void TheoryViaPropertyAcceptanceTest()
    {
        ...
        ResultXmlUtility.AssertResult(assemblyNode, "Pass", "Stub." + @"PassingTestData(1, ""hello world"", 2.3)");
    }
    ...
    public void TheoryViaXlsAcceptanceTest()
    {
        ...
        XmlNode testNode1 = ResultXmlUtility.GetResult(assemblyNode, 0, 0);
        ResultXmlUtility.AssertAttribute(testNode1, "result", "Pass");
        ResultXmlUtility.AssertAttribute(testNode1, "name", "Stub." + @"PassingTestData(1, ""Foo"", ""Bar"")");

        XmlNode testNode2 = ResultXmlUtility.GetResult(assemblyNode, 0, 1);
        ResultXmlUtility.AssertAttribute(testNode2, "result", "Pass");
        ResultXmlUtility.AssertAttribute(testNode2, "name", "Stub." + @"PassingTestData(null, null, null)");

        XmlNode testNode3 = ResultXmlUtility.GetResult(assemblyNode, 0, 2);
        ResultXmlUtility.AssertAttribute(testNode3, "result", "Pass");
        ResultXmlUtility.AssertAttribute(testNode3, "name", "Stub." + @"PassingTestData(14, ""Biff"", ""Baz"")");
    }
    ...
    public void IncorrectParameterCountThrows()
    {
        ...
        XmlNode testNode1 = ResultXmlUtility.GetResult(assemblyNode, 0, 0);
        ResultXmlUtility.AssertAttribute(testNode1, "result", "Pass");
        ResultXmlUtility.AssertAttribute(testNode1, "name", "Stub." + @"PassingTestData(1)");

        XmlNode testNode2 = ResultXmlUtility.GetResult(assemblyNode, 0, 1);
        ResultXmlUtility.AssertAttribute(testNode2, "result", "Fail");
        ResultXmlUtility.AssertAttribute(testNode2, "name", "Stub." + @"PassingTestData(2, 3)");
        ...
        XmlNode testNode3 = ResultXmlUtility.GetResult(assemblyNode, 0, 2);
        ResultXmlUtility.AssertAttribute(testNode3, "result", "Pass");
        ResultXmlUtility.AssertAttribute(testNode3, "name", "Stub." + @"PassingTestData(4)");
    }
