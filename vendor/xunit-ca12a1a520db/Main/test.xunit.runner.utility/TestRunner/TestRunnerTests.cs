...
<assembly name='C:\foo\bar.dll' run-date='2008-09-20' run-time='12:34:56' time='0.000' total='1' passed='0' failed='0' skipped='1'>
    <class time='1.234' name='ThisIsTheType' total='1' passed='0' failed='0' skipped='1'>
        ...
        [Fact]
        public void CurrentDirectoryIsPreserved()
        {
            TestableTestRunner runner = TestableTestRunner.CreateForAssembly();
            string currentDirectory = Directory.GetCurrentDirectory();
            runner.Executor.RunAssembly__CallbackEvent += delegate { Directory.SetCurrentDirectory(Path.GetTempPath()); };
...
<class time='1.234' name='Class.Name' total='1' passed='0' failed='1' skipped='0'>
    <failure exception-type='Exception.Type'>
        ...
        public void CurrentDirectoryIsPreserved()
        {
            TestableTestRunner runner = TestableTestRunner.CreateForAssembly();
            string currentDirectory = Directory.GetCurrentDirectory();
            runner.Executor.RunClass__CallbackEvent += delegate { Directory.SetCurrentDirectory(Path.GetTempPath()); };
...
<class time='1.234' name='Class.Name' total='1' passed='0' failed='1' skipped='0'>
    <failure exception-type='Exception.Type'>
        ...
        public void CurrentDirectoryIsPreserved()
        {
            TestableTestRunner runner = TestableTestRunner.CreateForAssembly();
            string currentDirectory = Directory.GetCurrentDirectory();
            runner.Executor.RunTest__CallbackEvent += delegate { Directory.SetCurrentDirectory(Path.GetTempPath()); };

            runner.RunTest(null, null);
